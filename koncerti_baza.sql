...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 09, 2019 at 01:03 PM
...
(15, 5, 1, 'Ponovo', '2019-09-15', 'Arena', '', 'cellos.jpg', ''),
...
(9, 'admin', 'admin', 'Admin', 'Admin', 'admin@gmail.com', 'muski', 'admin');
...
--
ALTER TABLE `korisnici`
  MODIFY `id_korisnici` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `rezervacija`
--
ALTER TABLE `rezervacija`
  MODIFY `id_rezervacije` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
